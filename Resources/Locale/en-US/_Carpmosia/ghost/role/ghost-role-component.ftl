...
ghost-role-information-closet-skeleton-rules-carpmosia = You are a [color={role-type-free-agent-color}][bold]{role-type-free-agent-name}[/bold][/color]. You needn't have any loyalty to the station, but [bold]antagonistic actions should be justified through roleplay[/bold].
